...
@Composable
fun SaveButton(
    isSaved: Boolean, saveCount: String, onSaveClick: (Boolean) -> Unit
) {
    ...
    val iconSize by animateDpAsState(targetValue = if (animateTrigger) 33.dp else 32.dp,
    ...
    Box(
        ...
        Icon(
            ...
            tint = if (isSaved) Color(0xFFFFEB3B) else Color.White,
    ...
    LaunchedEffect(isSaved) {
        if (!isSaved) animateTrigger = false
    }
